...
class InstallCommand extends \Symfony\Component\Console\Command\Command
{
     ...
     * @inerhitDoc
     */
    protected static $defaultName = 'netzarbeiter:custom-fields:install';

    /**
     * @inerhitDoc
     */
    protected static $defaultDescription = 'Install custom fields';
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->customFieldService->install($manifestFile, $this->context);
        $this->io->success('Custom fields installed');
